...
class Subject_Sports1_Widget extends StatefulWidget {
  const Subject_Sports1_Widget({super.key});

  @override
  State<Subject_Sports1_Widget> createState() => _Subject_Sports1_WidgetState();
}

class _Subject_Sports1_WidgetState extends State<Subject_Sports1_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Sports1');
