...
class Subject_Etc1_Widget extends StatefulWidget {
  const Subject_Etc1_Widget({super.key});

  @override
  State<Subject_Etc1_Widget> createState() => _Subject_Etc1_WidgetState();
}

class _Subject_Etc1_WidgetState extends State<Subject_Etc1_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Etc1');
