...
class Subject_Study1_Widget extends StatefulWidget {
  const Subject_Study1_Widget({super.key});

  @override
  State<Subject_Study1_Widget> createState() => _Subject_Study1_WidgetState();
}

class _Subject_Study1_WidgetState extends State<Subject_Study1_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Study1');
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: '스터디 주제을 입력 해 주세요.'),
                ),
                TextField(
