...
class Subject_Play1_Widget extends StatefulWidget {
  const Subject_Play1_Widget({super.key});

  @override
  State<Subject_Play1_Widget> createState() => _Subject_Play1_WidgetState();
}

class _Subject_Play1_WidgetState extends State<Subject_Play1_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Play1');
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: '활을 입력 해 주세요.'),
                ),
                TextField(
