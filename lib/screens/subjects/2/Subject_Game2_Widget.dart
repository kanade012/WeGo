...
class Subject_Game2_Widget extends StatefulWidget {
  const Subject_Game2_Widget({super.key});

  @override
  State<Subject_Game2_Widget> createState() => _Subject_Game2_WidgetState();
}

class _Subject_Game2_WidgetState extends State<Subject_Game2_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Game2');
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: '정규 플레이 주기를 입력 해 주세요'),
                ),
                TextField(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          actions: [
            ElevatedButton(
                ...
                child: Text("지원하기")),ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pop();
                },
                child: Text("취소")),
