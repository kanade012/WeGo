...
class Subject_Study2_Widget extends StatefulWidget {
  const Subject_Study2_Widget({super.key});

  @override
  State<Subject_Study2_Widget> createState() => _Subject_Study2_WidgetState();
}

class _Subject_Study2_WidgetState extends State<Subject_Study2_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Study2');
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: '스터디 주제를 입력 해 주세요.'),
                ),
                TextField(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("스터디"), actions: [
        IconButton(
          onPressed: () async {
            setState(() {
              isAlarmed = !isAlarmed;
