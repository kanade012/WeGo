...
class Subject_Etc2_Widget extends StatefulWidget {
  const Subject_Etc2_Widget({super.key});

  @override
  State<Subject_Etc2_Widget> createState() => _Subject_Etc2_WidgetState();
}

class _Subject_Etc2_WidgetState extends State<Subject_Etc2_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Etc2');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("기타"), actions: [
        IconButton(
          onPressed: () async {
            setState(() {
              isAlarmed = !isAlarmed;
