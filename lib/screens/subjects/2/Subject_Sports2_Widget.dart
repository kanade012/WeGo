...
class Subject_Sports2_Widget extends StatefulWidget {
  const Subject_Sports2_Widget({super.key});

  @override
  State<Subject_Sports2_Widget> createState() => _Subject_Sports2_WidgetState();
}

class _Subject_Sports2_WidgetState extends State<Subject_Sports2_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Sports2');
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: '스포츠 종목을 입력 해 주세요.'),
                ),
                TextField(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("스포츠"), actions: [
        IconButton(
          onPressed: () async {
            setState(() {
              isAlarmed = !isAlarmed;
