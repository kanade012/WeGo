...
class Subject_Play2_Widget extends StatefulWidget {
  const Subject_Play2_Widget({super.key});

  @override
  State<Subject_Play2_Widget> createState() => _Subject_Play2_WidgetState();
}

class _Subject_Play2_WidgetState extends State<Subject_Play2_Widget> {
  @override
  CollectionReference product = FirebaseFirestore.instance.collection('Play2');
  final TextEditingController titleController = TextEditingController();
  final TextEditingController JongMokController = TextEditingController();
  ...
  final TextEditingController IlJungController = TextEditingController();
  ...
  Future<void> _update(DocumentSnapshot documentSnapshot) async {
    ...
    JongMokController.text = documentSnapshot['type'];
    ...
    IlJungController.text = documentSnapshot['IlJung'];
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  controller: JongMokController,
                  decoration: InputDecoration(labelText: '활동 입력 해 주세요.'),
                ),
                TextField(
                  controller: IlJungController,
                  decoration: InputDecoration(labelText: '일정 주기를 입력 해 주세요'),
                ),
                TextField(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(labelText: '연락 받을 수단을 입력 해 주세요'),
                ),
                TextField(
                ...
                Center(
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final String mode = JongMokController.text;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  controller: JongMokController,
                  decoration: InputDecoration(labelText: '활동을 입력 해 주세요.'),
                ),
                TextField(
                  controller: IlJungController,
                  decoration: InputDecoration(labelText: '일정 주기를 입력 해 주세요'),
                ...
                Center(
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final String IlJung = IlJungController.text;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("여가"), actions: [
        IconButton(
          onPressed: () async {
            setState(() {
              isAlarmed = !isAlarmed;
